 ...
 */
export const isHexColour = (str: string) => {
 ...
 */
export const getHexColour = (str: string) => {
    if (isHexColour(str)) {
...
export class ColourGradient {
    ...
    setGradient (start: string, end: string) {
        this.startColour = getHexColour(start);
        this.endColour = getHexColour(end);
        return this;
    }
...
export class Rainbow {
    ...
    overColors (...colors: string[]) {
        this.setSpectrum(...colors);
        return this;
    }

    withRange(min: number, max: number) {
...
export const rainbow = (args = {}) => new Rainbow(args);
